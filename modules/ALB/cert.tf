...
# Create the certificate using a wildcard for all the domains created in larrymie.click
resource "aws_acm_certificate" "project_19_cert" {
  domain_name       = "*.larrymie.click"
